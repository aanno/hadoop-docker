...
$DOCKER build -v $PWD/tmp:/tmp:z -v $PWD/tmp/pip:/root/.cache/pip:z -v $PWD/tmp/var/cache/apt/archives:/var/cache/apt/archives:z -t localhost/hadoop-base:3.3.6 -f Dockerfile-hadoop .
